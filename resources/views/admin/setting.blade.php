                ...
                <form class="row g-3">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="row">
                            ...
                            <div class="file-upload-container col-lg-4 col-md-4 col-12">
                                {{-- Image 1 --}}
                            ...
                            <div class="file-upload-container col-lg-8 col-md-8 col-12">
                                <img id="image-preview" src="{{ asset('img/logo.svg') }}" alt="Image Preview">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12">
