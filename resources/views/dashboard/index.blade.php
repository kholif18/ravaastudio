    ...
    <section class="product spad">
        <div class="container">
            ...
            <div class="row property__gallery">
                <div class="col-lg-3 col-md-4 col-sm-6 mix banner">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix sablon">
                    <div class="product__item">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix atk">
                    <div class="product__item">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix undangan">
